...
var NNI973078612 = {kind: 1, offset: "reason0", len: 0, typ: NTI671088767, name: "reason0", sons: null};
NTI973078612.node = NNI973078612;
NTI973078612.base = NTI33555163;
      ...
      Label3: {
        F.line = 129;
          ...
          if (!(i_973078683 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990107 = i_973078683;
            F.line = 47;
  ...
  BeforeRet: {
    ...
    Label2: {
      ...
      Label3: {
        F.line = 97;
          Label4: while (true) {
          if (!(res_973078700 <= last_989857385)) break Label4;
            F.line = 1986;
            F.filename = "strutils.nim";
            iHEX60gensym176_989857399 = res_973078700;
...
function nsuInitSkipTable(a_p0, sub_p1) {
  ...
  framePtr = F;
    ...
    Label1: {
      ...
      F.line = 1904;
      F.filename = "strutils.nim";
      colontmp__973078705 = subInt(m_989857305, 1);
      F.line = 128;
      F.filename = "iterators_1.nim";
      var i_973078706 = 0;
      Label2: {
...
async function main__asyncjs95examples952_u26() {
  ...
  BeforeRet: {
    ...
    if (!(contains__pureZstrutils_u1807(cstrToNimstr(HEX3Aenv_973078631.reason0.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 251;
