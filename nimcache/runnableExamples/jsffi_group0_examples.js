  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_922746917 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
...
F.line = 224;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsffi_examples_2.nim(11, 3) `obj.a.to(int) == 20` "));
}
