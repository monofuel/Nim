  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_654311680 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990107 = i_654311680;
            F.line = 47;
...
function HEX3DHEX3D__jscore95examples951_u14(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    F.line = 327;
    sameObject_654311450 = x_p0 === y_p1;
    ...
    Label1: {
      ...
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__654311665 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_654311667 = 0;
      Label2: {
        F.line = 97;
          ...
          if (!(res_654311667 <= colontmp__654311665)) break Label3;
            ...
            if (!((x_p0[chckIndx(i_654311464, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_654311464, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_654311442 = false;
            break BeforeRet;
            }
...
function HEX3DHEX3D__jscore95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__654311685 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_654311686 = 0;
      Label2: {
        F.line = 97;
          ...
          if (!(res_654311686 <= colontmp__654311685)) break Label3;
            ...
            if (!((x_p0[chckIndx(i_654311522, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_654311522, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_654311500 = false;
            break BeforeRet;
            }
...
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(9, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(0, 3, 4) == @[\'d\', \'b\', \'c\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u14(new Uint8Array([97, 98, 99, 100, 101]).copyWithin(1, 3), [97, 100, 101, 100, 101]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(10, 3) `[\'a\', \'b\', \'c\', \'d\', \'e\'].copyWithin(1, 3) == @[\'a\', \'d\', \'e\', \'d\', \'e\']` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin((-2)), [1, 2, 3, 1, 2]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(11, 3) `[1, 2, 3, 4, 5].copyWithin(-2) == @[1, 2, 3, 1, 2]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3), [4, 5, 3, 4, 5]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(12, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3) == @[4, 5, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin(0, 3, 4), [4, 2, 3, 4, 5]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(13, 3) `[1, 2, 3, 4, 5].copyWithin(0, 3, 4) == @[4, 2, 3, 4, 5]` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(new Int32Array([1, 2, 3, 4, 5]).copyWithin((-2), (-3), (-1)), [1, 2, 3, 3, 4]))) {
F.line = 133;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_1.nim(14, 3) `[1, 2, 3, 4, 5].copyWithin(-2, -3, -1) == @[1, 2, 3, 3, 4]` "));
}
...
F.line = 145;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(10, 3) `arrai.shift() == 1` "));
}

if (!(HEX3DHEX3D__jscore95examples951_u72(arrai_721420295[0], [2, 3]))) {
F.line = 145;
failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jscore_examples_2.nim(11, 3) `arrai == @[2, 3]` "));
}
