...
var NTI654311479 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI654311479 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554450, name: "Field1", sons: null}]};
NTI654311479.node = NNI654311479;
var NNI654311511 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554450, name: "Field1", sons: null}]};
  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_654311685 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
...
function HEX3DHEX3D__jsheaders95examples951_u13(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    F.line = 327;
    sameObject_654311449 = x_p0 === y_p1;
    ...
    Label1: {
      ...
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__654311690 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_654311692 = 0;
      Label2: {
        F.line = 97;
          ...
          if (!(res_654311692 <= colontmp__654311690)) break Label3;
            ...
            if (!((x_p0[chckIndx(i_654311463, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_654311463, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_654311441 = false;
            break BeforeRet;
            }
...
function HEX3DHEX3D__jsheaders95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    F.line = 327;
    sameObject_654311508 = x_p0 === y_p1;
    ...
    Label1: {
      ...
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__654311695 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_654311696 = 0;
      Label2: {
        F.line = 97;
          ...
          if (!(res_654311696 <= colontmp__654311695)) break Label3;
            ...
            if (!(HEX3DHEX3D__jsheaders95examples951_u99(x_p0[chckIndx(i_654311522, 0, (x_p0).length - 1)], y_p1[chckIndx(i_654311522, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_654311500 = false;
            break BeforeRet;
            }
...
Label1: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(13, 5) `header.hasKey(\"key\")` "));
  }
  
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_654311427.keys()), ["key"]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(14, 5) `header.keys() == @[\"key\".cstring]` "));
  }
  
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_654311427.values()), ["value"]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(15, 5) `header.values() == @[\"value\".cstring]` "));
  }
  
  if (!((header_654311427.get("key") == "value"))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(16, 5) `header[\"key\"] == \"value\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(18, 5) `header[\"other\"] == \"another\".cstring` "));
  }
  
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_654311427.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI654311479), nimCopy(null, {Field0: "other", Field1: "another"}, NTI654311479)]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(19, 5) `header.entries() ==\x0A    @[(\"key\".cstring, \"value\".cstring), (\"other\".cstring, \"another\".cstring)]` "));
  }
  
  if (!((JSON.stringify(Array.from(header_654311427.entries())) == "[[\"key\",\"value\"],[\"other\",\"another\"]]"))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(20, 5) `header.toCstring() == \"\"\"[[\"key\",\"value\"],[\"other\",\"another\"]]\"\"\".cstring` "));
  }
  
  F.line = 51;
  header_654311427.delete("other");
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_654311427.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI654311511)]))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(22, 5) `header.entries() == @[(\"key\".cstring, \"value\".cstring)]` "));
  }
  
  F.line = 51;
  (() => { const header = header_654311427; Array.from(header.keys()).forEach((key) => header.delete(key)) })();
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_654311427.entries()), []))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(24, 5) `header.entries() == @[]` "));
  }
  
  if (!((Array.from(header_654311427.entries()).length == 0))) {
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(25, 5) `header.len == 0` "));
  }
...
Label2: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(32, 5) `header[\"key\"] == \"a, b, c\".cstring` "));
  }
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(34, 5) `header[\"key\"] == \"value\".cstring` "));
  }
...
Label3: {
  ...
  F.line = 51;
  failedAssertImpl__stdZassertions_u85(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsheaders_examples_1.nim(40, 5) `header[\"key\"] == \"b\".cstring` "));
  }
